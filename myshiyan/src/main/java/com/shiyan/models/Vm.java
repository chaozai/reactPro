...
import com.shiyan.core.VmStateHistoryEntry;
import com.shiyan.main.CloudletScheduler;
...
public class Vm {
	...
	public Vm(
		    ...
		    initVm(id,userId,mips,numberOfPes,ram,bw,size,vmm,cloudletScheduler);
	...
	public Vm(
		    ...
		    this.setCostPerVm(costPerVm);
	}
	private void initVm(int id, int userId, double mips, int numberOfPes, int ram, long bw, long size,String vmm,CloudletScheduler cloudletScheduler) {
	...
	public double getCurrentWrongProbability() {
		return getCloudletScheduler().getCurrentWrongProbability();
	}
	...
	/**
	 * Gets unique string identifier of the VM.获取VM的惟�?字符串标识符�?
	 * 
	 * @return string uid
	 */
	...
	/**
	 * Gets the vm scheduler.获取vm调度程序
	 * 
	...
	/**
	 * Gets the current allocated size.获取当前分配的大�?
	 * 
	...
	/**
	 * Checks if is being instantiated.检查这个虚拟机是否正在实例化�?
	 * 
	...
	/**
	 * Sets the being instantiated.设置被实例化的对�?
	 * 
	...
	/**
	 * Adds a VM state history entry.添加VM状�?�历史记录条�?
	 * 
	 * @param time the time
	...
	public void addStateHistoryEntry(
			...
			double currentWrongProbability,
	 ...
	 */
	public Double getlowUtilizationHistory(){
	
		return utilizationHistory;
	}
	
	public void setUtilizationHistory(Double Utilization){
		
		this.utilizationHistory = Utilization;
	}
