...
public class CloudSimTags {
	 ...
	 * {@link CloudInformationService} and CloudResouce entities.姝ゆ爣绛鹃�氬父鐢ㄤ簬浜戞湇鍔″拰浜戞湇鍔″疄浣撲箣闂�
	 */
	...
	/**
	 * Denotes cloud resource characteristics information. This tag is normally used between CloudSim杩欎釜鏍囩閫氬父鍦–loudSim鍜孋loudResource瀹炰綋涔嬮棿浣跨敤
	 ...
	 * between CloudSim and CloudResource entity.琛ㄧず瀵逛簯璧勬簮鐗瑰緛淇℃伅鐨勮姹�
	 */
