...
public class CloudSimShutdown extends SimEntity {
	...
	/**
	 * The main method that shuts down hostList's and Cloud Information Service (CIS). In addition,关闭主机列表和Cloud Information Service(CIS)的主要方法
	 * this method writes down a report at the end of a simulation based on 该方法在基于的模拟结束时写下了一份报告
