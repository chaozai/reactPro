...
import com.shiyan.provisioners.PeProvisioner;
...
public class VmSchedulerTimeShared extends VmScheduler {
	...
	/**
	 * Update allocation of VMs on PEs.更新PEs上vm的分配
	...
	@Override
	public int getVmsMigrationSize() {
		return getVmsMigratingIn().size()+getVmsMigratingOut().size();
	}
