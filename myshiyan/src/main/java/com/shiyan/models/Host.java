...
public class Host{
	...
	/**
	 * Removes a migrating in vm. 删除vm中的迁移
	 * 
	 * @param vm the vm
	 */
	...
	/**
	 * Destroys Special VM running in the host.
	 * 
	 * @param vm the VM
	 * @pre $none
	 * @post $none
	 */
	public void vmSpecialDestroy(List<Vm> specialvm) {
		if (specialvm != null) {
			for(Vm vm: specialvm) {
				vmDestroy(vm);
			}
	 ...
	 * Sets the storage.
	 * 
	 * @param storage the new storage新存�?
	 */
